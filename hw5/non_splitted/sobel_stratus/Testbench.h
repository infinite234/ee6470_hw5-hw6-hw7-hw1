...
public:
 ...
 cynw_p2p< sc_dt::sc_uint<24> >::base_out o_g;
 cynw_p2p< sc_dt::sc_uint<24> >::base_out o_b;
 cynw_p2p< sc_dt::sc_uint<24> >::base_in i_resultr;
 cynw_p2p< sc_dt::sc_uint<24> >::base_in i_resultg;
	cynw_p2p< sc_dt::sc_uint<24> >::base_in i_resultb;
#else
	sc_fifo_out< sc_dt::sc_uint<24> > o_r;
 sc_fifo_out< sc_dt::sc_uint<24> > o_g;
 sc_fifo_out< sc_dt::sc_uint<24> > o_b;
 sc_fifo_out< sc_dt::sc_uint<24> > i_resultr;
 sc_fifo_out< sc_dt::sc_uint<24> > i_resultg;
	sc_fifo_in< sc_dt::sc_uint<24> > i_resultb;
#endif
